...
public class ProfileManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        popUpAuthError_Text = GameObject.Find("PopUpAuthError_Text").GetComponent<TMP_Text>();
    ...
    IEnumerator FetchPlayerProfile()
    {
        ...
        int score = GlobalManager.Instance.Score;
        ...
        using (UnityWebRequest request = UnityWebRequest.Get(url))
        {
            ...
            string jwtToken = GlobalManager.Instance.JwtToken;
    ...
    IEnumerator UpdatePlayerProfile()
    {
        ...
        using (UnityWebRequest request = UnityWebRequest.Put(url, requestData))
        {
            ...
            Debug.Log(GlobalManager.Instance.JwtToken);
            request.SetRequestHeader("Authorization", "Bearer " + GlobalManager.Instance.JwtToken);
            Debug.Log(request);
